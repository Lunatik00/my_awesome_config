...
globalkeys = gears.table.join(
    ...
    -- Prompt
    awful.key({ modkey , alt},       "r",     function () awful.screen.focused().mypromptbox:run() end,
...
if not xresources:match(xresources_name) then
    ...
    -- autostart()
    -- os.execute("dex --environment Awesome --autostart --search-paths $HOME/.config/autostart")
    os.execute("python $HOME/.config/awesome/autostart.py")
